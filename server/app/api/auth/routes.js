...
export default async function routes(fastify, options) {
  ...
  fastify.post("/forgot-password", {}, (req, res) =>
    controller.sendResetToken(req, res, "password")
  );
  fastify.post("/reset-password", {}, userController.resetPassword);

  fastify.post("/forgot-username", {}, (req, res) =>
    controller.sendResetToken(req, res, "username")
  );
  fastify.post("/reset-username", {}, userController.resetUsername);
}
