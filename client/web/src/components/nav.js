                        ...
                        {item.categories.map(
                          (category, index) => (
                            ...
                            >
                              ...
                              {/* Products */}
                              <div className="mt-5 max-h-[250px] space-y-1 overflow-y-auto">
                                {category.products.map(
                                  (product) => (
                                    <Link
                                      ...
                                      "
                                    >
                                      <span className="pr-3 text-[13px] lg:text-sm">
                                        {product.title}
                                      </span>
      ...
      >
        ...
        <div className="mt-auto px-5 pb-8 pt-10">
          ...
          <p
            ...
            "
          >
            Plot No. 732, Sector- 69, I.M.T., Faridabad,
            Haryana- 121004
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M100.28 448H7.4V148.9h92.88zm-46.44-341a53.79 53.79 0 1 1 53.79-53.79 53.79 53.79 0 0 1-53.79 53.79zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
              </svg>
            </a>
